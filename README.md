...
*Note: you will see a message printed on the terminal to confirm the server has been gracefully killed. A graceful kill will delete _all_ files that were generated by the server except the files created from committed transactions.*
